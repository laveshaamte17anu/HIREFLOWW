    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 text-xs mt-0.5">Recruiter alerts for new candidate applications and activity.</p>
        </div>
      ...
      {notifications.length === 0 ? (
        <div className="bg-white p-12 text-center rounded-3xl border border-slate-200">
          ...
          <p className="text-slate-400 text-xs mt-1">Notifications will trigger when candidates apply for your job postings.</p>
        </div>
      ) : (
