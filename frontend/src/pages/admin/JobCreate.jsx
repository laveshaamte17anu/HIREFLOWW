  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 text-slate-100 font-sans">
      ...
      <div className="bg-slate-900 p-8 rounded-3xl border border-slate-800 shadow-xl space-y-6">
        <div>
          <h1 className="text-2xl font-black text-white tracking-tight">Create New Job Listing</h1>
          <p className="text-slate-400 text-xs mt-0.5">Publish job opportunities directly to the candidate job portal.</p>
        </div>
