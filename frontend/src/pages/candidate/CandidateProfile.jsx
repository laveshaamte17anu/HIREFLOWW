  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 text-slate-100 font-sans">
      <div>
        ...
        <p className="text-slate-400 text-xs mt-0.5">Keep your credentials up to date to improve job recommendations and recruiter review.</p>
      </div>
      ...
      <div className="bg-slate-900 p-8 rounded-3xl border border-slate-800 shadow-xl">
        <form onSubmit={handleSubmit} className="space-y-6 text-xs font-medium">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-slate-950 border border-slate-800 rounded-xl outline-none focus:border-blue-500 text-xs text-white"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  disabled
                  value={user?.email || ''}
                  className="w-full px-4 py-2.5 bg-slate-950/60 border border-slate-800 text-slate-500 rounded-xl cursor-not-allowed text-xs"
                />
              </div>
            </div>
            ...
            <div>
              <label className="block text-slate-300 font-bold mb-1">Professional Bio / Overview</label>
              <div className="relative">
                <AlignLeft className="w-4 h-4 text-slate-500 absolute left-3.5 top-3" />
                <textarea
                  rows="3"
                  placeholder="Brief summary of your professional expertise..."
                  value={bio}
                  onChange={(e) => setBio(e.target.value)}
                  className="w-full pl-10 pr-4 py-2.5 bg-slate-950 border border-slate-800 rounded-xl outline-none focus:border-blue-500 text-xs text-white resize-none"
                ></textarea>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4 pt-4 border-t border-slate-800">
            <h3 className="text-sm font-bold text-white border-b border-slate-800 pb-2">Education & Experience</h3>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div>
                <label className="block text-slate-300 font-bold mb-1">College / University</label>
                <div className="relative">
              ...
              <div>
                <label className="block text-slate-300 font-bold mb-1">Degree / Field of Study</label>
                <input
                  type="text"
            ...
            <div>
              <label className="block text-slate-300 font-bold mb-1">Technical Skills (comma separated)</label>
              <div className="relative">
          ...
          {/* Online Profiles */}
          <div className="space-y-4 pt-4 border-t border-slate-800">
            <h3 className="text-sm font-bold text-white border-b border-slate-800 pb-2">Online Profiles & Links</h3>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
              ...
              <div>
                <label className="block text-slate-300 font-bold mb-1">Portfolio Website</label>
                <div className="relative">
          ...
          <div className="space-y-3 pt-4 border-t border-slate-800">
            <h3 className="text-sm font-bold text-white border-b border-slate-800 pb-2">Profile Resume</h3>
            ...
            {existingResume && (
              <div className="p-3 bg-blue-950/60 border border-blue-500/30 rounded-xl flex items-center justify-between text-xs">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-bold text-white">Current Resume:</span>
                  <a
            ...
            <div className="border-2 border-dashed border-slate-800 hover:border-blue-500 p-4 rounded-2xl text-center bg-slate-950">
              ...
              <label htmlFor="profile-resume-input" className="cursor-pointer space-y-1 block">
                ...
                <p className="text-xs font-bold text-white">
                  {resumeFile ? resumeFile.name : existingResume ? 'Upload new resume file to replace' : 'Click to upload your resume (PDF, DOC, DOCX up to 5MB)'}
                </p>
              </label>
            </div>
          </div>
          ...
          <div className="pt-4 flex justify-end">
            <button
              type="submit"
              disabled={submitting}
              className="px-8 py-3 bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs rounded-xl shadow-md shadow-blue-600/30 transition-all flex items-center space-x-2 cursor-pointer"
            >
